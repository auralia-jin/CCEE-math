...
## Overview
This repository provides a **structured, labeled JSON dataset** of real and mock mathematics questions from the **Beijing National College Entrance Examination (CCEE)** and senior‑high mock exams, covering **2021–2025**.
...
- Exam types:
  - Official Beijing CCEE mathematics real questions
...
## Typical Use Cases
1. Automated evaluation of **LLM CCEE math problem‑solving ability**
